...
`scripts/gbif_sourcing.R` retriev and standardization of GBIF *Bathynomus* records.

`data/gbif_output.csv` example output generated by the demo script.
...
distributions of rare Bathynomus species (≤ 50 observations), separating
